...
?>
        <li>
          ...
          <div class="topimg"> <a href="<?php echo $this->_var['goods']['url']; ?>"><img src="<?php echo $this->_var['goods']['thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>" style="width:220px; height:220px;" /></a>
          ...
          <div class="top_txt"> <b><a href="<?php echo $this->_var['goods']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>"><?php echo $this->_var['goods']['short_name']; ?></a></b>
            <p><?php echo $this->_var['lang']['shop_price']; ?><font class="f1"><?php echo $this->_var['goods']['price']; ?></font></p>
            <p><?php echo $this->_var['goods']['goods_number']; ?>人已购买</p>
          </div>
        </li>
