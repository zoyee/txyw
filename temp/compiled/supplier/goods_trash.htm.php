            ...
            <div class="col-sm-12">
                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content">
						...
						<form action="goods.php?act=trash" method="post" class="bs-example bs-example-form" id="query_form">
						<div class="col-md-12">
...
?>
                                    <tr>
									    ...
									    <?php endif; ?>
									    <td>
									      <a href="goods.php?act=restore_goods&id=<?php echo $this->_var['goods']['goods_id']; ?>" title="还原" target="ajax" class="btn btn-primary btn-sm">还原</a>
									      <a href="goods.php?act=drop_goods&id=<?php echo $this->_var['goods']['goods_id']; ?>" title="彻底删除" target="tab" class="btn btn-primary btn-sm btn-del">删除</a>
									    </td>
                                    </tr>
