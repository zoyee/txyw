 ...
 <dd class="hot_dd02" >
  <div class="hot_img"> <span class="hot1"></span>
        ...
        <div class="pic">   <a href="<?php echo $this->_var['goods']['url']; ?>"><img src="<?php echo $this->_var['goods']['thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>" class="goodsimg" /></a></div>
          ...
          <?php endif; ?>
           </font><font class="bb"><?php echo $this->_var['goods']['market_price']; ?></font>
           </p>
        </div>
        </div>
         <div class="hot_btn"><a href="javascript:addToCartShowDiv(<?php echo $this->_var['goods']['id']; ?>,1,'best')"  ></a> </div>
