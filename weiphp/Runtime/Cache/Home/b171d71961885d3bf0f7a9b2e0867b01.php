...
<script type="text/javascript" src="/weiphp/Public/static/zclip/ZeroClipboard.min.js?v=<?php echo SITE_VERSION;?>"></script>
...
<div class="login_header">
    ...
    <div class="log_wrap">
        <a href="/" title="WeiPHP"><img class="logo" src="/weiphp/Public/Home/images/logo.png"/></a>
    </div>
    	...
    	<div class="top_content">
        	<div class="log_wrap">
            	<div class="top_content_r">
                	<img src="/weiphp/Public/Home/images/about/img/banner_pic.png?20150723"/>
                </div>
            	<section class="login_box">
                  <form class="login-form" action="/weiphp/index.php?s=/Home/User/login/from/1.html" method="post">
