...
<div class="navbar navbar-inverse navbar-fixed-top">
    <div class="wrap">
       ...
       <?php if(!empty($userInfo[website_logo])): ?><img height="52" src="<?php echo (get_cover_url($userInfo["website_logo"])); ?>"/>
       	<?php else: ?>
       		<img height="52" src="/weiphp/Public/Home/images/logo.png"/><?php endif; ?>
       </a>
...
<section id="contents">
  <div class="tab-content" style="margin:30px auto;"> 
      ...
      <div class="tab-pane in tab1" id="tab1">
        <div class="item_wrap">
          <h3 style="padding-bottom:30px; text-align:center">绑定扫码登录公众号</h3>
          <div class="form_body" id='scan_login'>
              <div class="input_panel">
              <div id="qrCode"><img src="<?php echo ($qrcode); ?>" /></div>
              <p class="qr_time_tips">如未关注公众号，先关注即可绑定，绑定后就可以直接扫码登录</p>
              </div>
              </div>
      </div>
...
$(function(){
	setInterval(function(){
		$.post("<?php echo U('bind_login');?>",{},function(res){
			if(res==1){
