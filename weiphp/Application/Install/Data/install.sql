...
) ENGINE=MyISAM AUTO_INCREMENT=3946 DEFAULT CHARSET=utf8 COMMENT='行为日志表';
...
) ENGINE=MyISAM AUTO_INCREMENT=164 DEFAULT CHARSET=utf8 COMMENT='微信插件表';
...
) ENGINE=MyISAM AUTO_INCREMENT=11356 DEFAULT CHARSET=utf8 COMMENT='模型属性表';
...
INSERT INTO `wp_attribute` VALUES ('11288', 'name', '分类名称', 'varchar(255) NULL', 'string', '', '', '1', '', '1147', '0', '1', '1463800258', '1463800258', '', '3', '', 'regex', '', '3', 'function');
...
INSERT INTO `wp_config` VALUES ('47', 'FOLLOW_YOUKE_UID', '0', '粉丝游客ID', '0', '', '', '1398927704', '1398927704', '1', '-19029', '0');
...
CREATE TABLE `wp_credit_data` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=11455 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=105 DEFAULT CHARSET=utf8 COMMENT='文件表';
...
CREATE TABLE `wp_lucky_follow` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=28155 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=1153 DEFAULT CHARSET=utf8 COMMENT='系统模型表';
...
CREATE TABLE `wp_user` (
  ...
  PRIMARY KEY (`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=12449 DEFAULT CHARSET=utf8;
...
CREATE TABLE `wp_visit_log` (
  ...
  `cTime` int(10) DEFAULT NULL COMMENT '时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=31026 DEFAULT CHARSET=utf8;
...
CREATE TABLE `wp_weixin_log` (
  ...
  `data_post` text,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=58735 DEFAULT CHARSET=utf8;
...
CREATE TABLE `wp_xdlog` (
  ...
  `biztitle` text CHARACTER SET utf8,
