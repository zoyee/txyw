...
class WxHongBaoHelper
{
	...
	protected function get_sign(){
		define('PARTNERKEY',"clylT242kQjEVXZ62KXPYV1mhZZFK3WO");
		try {
	...
	*/
	...
	function curl_post_ssl($url, $vars, $second=30,$aHeader=array())
	{
		...
		curl_setopt($ch,CURLOPT_SSLCERT,dirname(__FILE__).DIRECTORY_SEPARATOR.'zhengshu'.DIRECTORY_SEPARATOR.'apiclient_cert.p12');
