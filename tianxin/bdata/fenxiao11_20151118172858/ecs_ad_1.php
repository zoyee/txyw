...
E_D("replace into `ecs_ad` values('24','7','0','团购列表左侧广告一','#','1390350714139310283.jpg','1390291200','1645344000','','','','237','1');");
E_D("replace into `ecs_ad` values('25','8','0','团购列表左侧广告二','#','1390350730168563820.jpg','1390291200','1582185600','','','','23','1');");
E_D("replace into `ecs_ad` values('26','9','0','团购列表左侧广告三','#','1390350744473328295.jpg','1390291200','1392883200','','','','0','1');");
E_D("replace into `ecs_ad` values('27','10','0','团购列表左侧广告四','#','1390350760626738934.jpg','1390291200','1708416000','','','','10','1');");
E_D("replace into `ecs_ad` values('28','11','0','团购列表页右侧广告一','#','1390518412643487010.jpg','1390464000','1708588800','','','','4','1');");
E_D("replace into `ecs_ad` values('29','12','0','团购列表页右侧广告二','#','1390518430908793815.jpg','1390464000','1613980800','','','','7','1');");
E_D("replace into `ecs_ad` values('30','13','0','团购列表页右侧广告三','#','1390518446394401991.jpg','1390464000','1645516800','','','','6','1');");
