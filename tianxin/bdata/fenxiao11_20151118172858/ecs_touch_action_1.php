...
E_D("replace into `ecs_touch_action` values('179','1','virualcard','');");
...
E_D("replace into `ecs_touch_action` values('182','138','wx_share_danpin','');");
...
E_D("replace into `ecs_touch_action` values('178','5','brand_manage','');");
...
E_D("replace into `ecs_touch_action` values('180','1','remove_back','');");
E_D("replace into `ecs_touch_action` values('181','1','comment_priv','');");
...
E_D("replace into `ecs_touch_action` values('174','0','db_manage','');");
E_D("replace into `ecs_touch_action` values('175','174','db_backup','');");
E_D("replace into `ecs_touch_action` values('176','174','db_optimize','');");
E_D("replace into `ecs_touch_action` values('177','174','sql_query','');");
E_D("replace into `ecs_touch_action` values('2','0','cms_manage','');");
E_D("replace into `ecs_touch_action` values('183','138','wx_share_shouye','');");
E_D("replace into `ecs_touch_action` values('184','138','wx_remind','');");
E_D("replace into `ecs_touch_action` values('185','164','user_rank','');");
