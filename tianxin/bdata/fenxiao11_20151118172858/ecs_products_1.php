...
E_D("replace into `ecs_products` values('2','24','167','','99');");
E_D("replace into `ecs_products` values('3','23','175','','98');");
E_D("replace into `ecs_products` values('4','21','188','','17');");
E_D("replace into `ecs_products` values('5','20','194','','13');");
E_D("replace into `ecs_products` values('6','17','201','','985');");
E_D("replace into `ecs_products` values('7','14','213','','4');");
E_D("replace into `ecs_products` values('8','13','217','','8');");
E_D("replace into `ecs_products` values('9','10','239','','4');");
E_D("replace into `ecs_products` values('10','10','240','','12');");
E_D("replace into `ecs_products` values('11','9','227','','99');");
E_D("replace into `ecs_products` values('12','9','226','','100');");
E_D("replace into `ecs_products` values('13','8','231','','17');");
E_D("replace into `ecs_products` values('14','1','237','','993');");
