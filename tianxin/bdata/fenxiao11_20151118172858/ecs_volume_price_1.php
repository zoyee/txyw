...
E_D("replace into `ecs_volume_price` values('1','154','1','20.00');");
E_D("replace into `ecs_volume_price` values('1','155','1','20.00');");
E_D("replace into `ecs_volume_price` values('1','158','12','5.00');");
E_D("replace into `ecs_volume_price` values('1','163','10','3.30');");
E_D("replace into `ecs_volume_price` values('1','163','20','3.00');");
