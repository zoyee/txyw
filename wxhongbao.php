...
//$comm = new Common_util_pub();
$data['mch_id'] = '1227128402';
$data['mch_billno'] = '1227128402'.date("Ymd",time()).date("His",time()).rand(1111,9999);
$data['nonce_str'] = self::createNoncestr();
$data['re_openid'] = $arr['openid'];
$data['wxappid'] = 'wx8e70f6100821dd9e';
...
return  $rearr;
	...
	public function getSign($Obj)
	{
		...
		//签名步骤二：在string后加入KEY
		$String = $String."&key="."clylT242kQjEVXZ62KXPYV1mhZZFK3WO";
