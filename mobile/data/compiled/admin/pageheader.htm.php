...
<!-- <a href="<?php echo $this->_var['action_link']['href']; ?>"><input class="button" type="button"  value="<?php echo $this->_var['action_link']['text']; ?>"></a> -->
<span class="action-span"><a href="<?php echo $this->_var['action_link']['href']; ?>"><?php echo $this->_var['action_link']['text']; ?></a></span>
<?php endif; ?>
...
<!-- <a href="<?php echo $this->_var['action_link2']['href']; ?>"><input class="button" type="button"  value="<?php echo $this->_var['action_link2']['text']; ?>"></a> -->
<span class="action-span"><a href="<?php echo $this->_var['action_link2']['href']; ?>"><?php echo $this->_var['action_link2']['text']; ?></a>&nbsp;&nbsp;</span>
<?php endif; ?>
