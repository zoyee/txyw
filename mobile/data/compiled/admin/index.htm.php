                    ...
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold"><?php echo $_SESSION['admin_name']; ?></strong></span>
                                <span class="text-muted text-xs block"><?php echo $_SESSION['admin_name']; ?><b class="caret"></b></span>
                                </span>
                            </a>
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li class="divider"></li>
                                <li><a href="privilege.php?act=logout">安全退出</a>
                                </li>
                            </ul>
                        </div>
...
?>
                    <li>
                    	...
                    	<?php else: ?>
                    	<a href="#">
                            <em class="h1_<?php echo $this->_var['k']; ?>"></em>
                            <span class="nav-label"><?php echo $this->_var['menu']['label']; ?></span>
                            <span class="fa arrow"></span>
                        </a>
...
?>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="index.php?act=main" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
            <div class="footer">
                <div class="pull-right">&copy; 2016 <a href="http://www.zi-han.net/" target="_blank"><?php echo $this->_var['_CFG']['shop_name']; ?></a>
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
