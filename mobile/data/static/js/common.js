 ...
 */
function addToCart_zmh(goodsId){
	...
	$.ajax({
		...
		url:"flow.php?step=add_to_cart&goods="+"{\"quick\":0,\"goods_id\":"+goodsId+",\"number\":1,\"parent\":0}",
		dataType:'json',
		data: {'goods':"{\"quick\":0,\"goods_id\":"+goodsId+",\"number\":1,\"parent\":0}"},
...
//      }
      openAlertDiv(result.message, "location.href = 'user.php';");
    }
...
function openAlertDiv(message, script)
...
if(script){
	html = '<div class="touchweb_com-indexPop pop_add-cart show" ><div class="inner"><div class="content_name"><p>' + message + '</p></div><div id="mcart_confirm_popup_btns" class="btn_box btn_center"><a href="javascript:' + script + '" class="btn btn_confirm">确定</a></div></div></div>';
}else{
	html = '<div class="touchweb_com-indexPop pop_add-cart show" ><div class="inner"><div class="content_name"><p>' + message + '</p></div><div id="mcart_confirm_popup_btns" class="btn_box btn_center"><a href="javascript:cancel_div()" class="btn btn_confirm">确定</a></div></div></div>';
}
...
function openConfirmDiv(message, script_confirm, script_cancel)
...
var cf;
if(script_cancel){
	html = '<div class="touchweb_com-indexPop pop_add-cart show" ><div class="inner"><div class="content_name"><p>' + message + '</p></div><div id="mcart_confirm_popup_btns" class="btn_box"><a href="javascript:' + script_cancel + '" class="btn btn_cancel">取消</a><a href="javascript:' + script_confirm + '" class="btn btn_confirm">确定</a></div></div></div>';
}else{
	html = '<div class="touchweb_com-indexPop pop_add-cart show" ><div class="inner"><div class="content_name"><p>' + message + '</p></div><div id="mcart_confirm_popup_btns" class="btn_box"><a href="javascript:cancel_div()" class="btn btn_cancel">取消</a><a href="javascript:' + script_confirm + '" class="btn btn_confirm">确定</a></div></div></div>';
}
