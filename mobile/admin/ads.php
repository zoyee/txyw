...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    /* 插入数据 */
    $sql = "INSERT INTO ".$ecs->table('touch_ad'). " (position_id,media_type,ad_name,ad_link,ad_code,start_time,end_time,link_man,link_email,link_phone,click_count,enabled,sort_order)
