...
elseif ($_REQUEST['act'] == 'edit_suppliers_name')
{
    ...
    $name   = json_str_iconv(trim($_REQUEST['val']));
...
function suppliers_list()
{
    ...
    if ($result === false)
    {
		...
		if($keyword){
			...
			$where = " where suppliers_name like '%$keyword%' ";
		}
        ...
        /* 查询 */
        $sql = "SELECT suppliers_id, suppliers_name, suppliers_desc, is_check, phone, weixin, head_img, province, city, district 
