...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    /*插入数据*/
    $sql = "INSERT INTO ".$ecs->table('brand')."(brand_name, site_url, brand_desc, is_show, sort_order";
    if($img_name){
    	$sql .= ", brand_logo";
    }
    if($banner_name){
    ...
    $sql .= ")";
    $value = "VALUES ('$_POST[brand_name]', '$site_url', '$_POST[brand_desc]', '$is_show', '$_POST[sort_order]'";
    if($img_name){
    	$value .= ", '$img_name'";
    }
    if($banner_name){
...
elseif ($_REQUEST['act'] == 'updata')
{
    ...
    $param = "site_url='$site_url', brand_desc='$_POST[brand_desc]', is_show='$is_show', sort_order='$_POST[sort_order]' ";
    if (!empty($img_name))
    {
        //有图片上传
