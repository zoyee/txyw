...
//商品管理权限
    ...
    $purview['special_cat_icons']    = 'special_cat_icons';
...
//  $purview['02_snatch_list']       = 'gift_manage';  //赠品管理
    ...
    $purview['questionnaire']        = 'questionnaire';//调查问卷
...
//会员管理权限
    ...
    $purview['10_user_account_setting']      = 'surplus_manage';
...
//商店设置权限
    ...
    $purview['04_mail_settings']     = 'mail_settings';// shop_config
...
//订单管理权限
    ...
    $purview['11_add_order']         = 'order_add';
...
//报表统计权限
    ...
    $purview['sale_product_list']    = 'sale_order_stats';
    $purview['sale_statis']       = 'sale_order_stats';
...
//模板管理
    ...
    $purview['haibao_template'] = 'haibao_template';
...
//商创微信通
    ...
    $purview['wx_hongbao_reply']           = 'wx_hongbao_reply';
    $purview['wx_smgz_reply']           = 'wx_smgz_reply';
    $purview['wx_msg_setting']           = 'wx_msg_setting';
	//手册
	//甜心  100  新增权限控制
    ...
    // 2015-09-17新增
    $purview['wx_1api']           = 'wx_api';
    $purview['wx_2config']           = 'wx_menu';
    $purview['wx_3menu']           = 'wx_menu';
    $purview['wx_4autoreg']           = 'wx_autoreg';
    $purview['wx_4autoreg']           = 'wx_autoreg';

	//2015-10-06
    $purview['wx_share_danpin']           = 'wx_share_danpin';
	$purview['wx_share_shouye']           = 'wx_share_shouye';
	$purview['wx_remind']           = 'wx_remind';
	$purview['user_rank']           = 'user_rank';
