...
/*甜   心 100 添加  */
$modules['02_cat_and_goods']['01_goods_list']       = 'goods.php?act=list&is_on_sale=1';         // 商品列表
...
$modules['02_cat_and_goods']['50_virtual_card_list']   = 'goods.php?act=list&extension_code=virtual_card&is_on_sale=1';
...
$modules['02_cat_and_goods']['special_cat_icons']    = 'special_cat.php?act=list';
$modules['02_cat_and_goods']['goods_original']    = 'goods_original.php?act=list';
...
$modules['03_promotion']['pintuan']       = 'pintuan.php?act=list';//

$modules['03_promotion']['questionnaire']       = 'questionnaire.php?act=list';//调查问卷
...
$modules['04_order']['11_add_order']                = 'order.php?act=add';
...
$modules['06_stats']['sale_product_list']           = 'sale_product_list.php?act=list';
...
$modules['06_stats']['sale_statis']              = 'sale_statis.php?act=list';
...
$modules['08_members']['10_user_account_setting']           = 'user_account.php?act=tixian_setting';
...
$modules['12_template']['haibao_template']       = 'haibao.php?act=list';
...
$modules['15_rec']['user_rank']                  ='user_rank.php?act=list';
...
$modules['17_wechat']['wx_hongbao_reply']        = 'wxch-ent.php?act=hongbao_reply';
$modules['17_wechat']['wx_smgz_reply']        = 'wxch-ent.php?act=smgz_reply';
...
//甜  心100新增 数据库管理菜单
$modules['19_backup']['02_db_manage']               = 'database.php?act=backup';
$modules['19_backup']['03_db_optimize']             = 'database.php?act=optimize';
$modules['19_backup']['04_sql_query']               = 'sql.php?act=main';
$modules['17_wechat']['wx_share_danpin']        = 'wxch-ent.php?act=share_danpin';
$modules['17_wechat']['wx_share_shouye']        = 'wxch-ent.php?act=share_shouye';
$modules['17_wechat']['wx_remind']        = 'wxch-ent.php?act=remind';
$modules['17_wechat']['wx_msg_setting']        = 'wxch-ent.php?act=wx_msg_list';
