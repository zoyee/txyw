...
$_LANG['unit_yuan'] = '元';
$_LANG['for_free'] = '赠品免费';
$_LANG['surplus_amount_error'] = '您要申请提现的金额超过了您现有的余额或重复提交，此操作将不可进行！';
...
$_LANG['username_no_mobile'] = '您填写的手机号码不存在，请重新输入！';
$_LANG['fail_send_password'] = '发送邮件出错，请与管理员联系！';
$_LANG['fail_send_password_sms'] = '发送短信出错，请与管理员联系！';
$_LANG['send_success'] = '重置密码的邮件已经发到您的邮箱：';
$_LANG['send_success_sms'] = '重置密码的短信已经发到您的手机：';
...
$_LANG['confirm_cancel'] = '取消后此订单将视为无效';
...
$_LANG['os'][OS_RETURNED_PEDDING] = '申请退货';
...
$_LANG['affiliate_intro'][0] = '　　微卖商城为鼓励推荐新用户注册，现开展<b>推荐注册分成</b>活动，活动流程如下：

　　１、将本站提供给您的推荐代码，发送到论坛、博客、微信上。
　　２、访问者点击链接，访问微卖商城
　　３、在访问者点击链接的 <b>%d%s</b> 内，若该访问者在微卖商城注册，即认定该用户是您推荐的，您将获得等级积分 <b>%d</b> 的奖励 (当您的等级积分超过 <b>%d</b> 时，不再获得奖励)。
　　４、该用户今后在本站的一切消费，您均能获得一定比例的提成。目前实行的提成总额为订单金额的 <b>%s</b> 、积分的 <b>%s</b> ，分配给您、推荐您的人等，具体分配规则请参阅 <b><a href="#myrecommend">我推荐的会员</a></b>。
　　５、提成由管理员人工审核发放，请您耐心等待。微卖商城返现相当消费10000元的订单，提成100元-150元左右的利润分成。
　　６、您可以通过分成明细来查看您的介绍、分成情况。';
$_LANG['affiliate_intro'][1] = '　　微卖商城为鼓励推荐新用户注册，现开展<b>推荐订单分成</b>活动，活动流程如下：

　　１、在浏览商品时，点击推荐此商品，获得推荐代码，将其发送到论坛、博客、微信上。
　　２、访问者点击链接，访问微卖商城。
