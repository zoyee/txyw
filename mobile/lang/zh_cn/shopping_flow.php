...
$_LANG['integral_not_enough'] = '您使用的青豆不能超过您现有的青豆。';
$_LANG['integral_too_much'] = "您使用的青豆不能超过%d";
...
$_LANG['remember_order_number'] = '感谢您在本店购物！您的订单号';
$_LANG['back_home'] = '<a style="height: 20px;" href="index.php">返回首页</a>';
$_LANG['goto_user_center'] = '<a style="height: 20px;" href="user.php">会员中心</a>';
$_LANG['order_submit_back'] = '%s%s';
