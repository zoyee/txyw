...
$_LANG['cfg_name']['integral_giving_setting'] = '赠送消费积设置';
$_LANG['cfg_range']['integral_giving_setting']['0'] = '按商品价格';
$_LANG['cfg_range']['integral_giving_setting']['1'] = '按订单实付金额';

$_LANG['cfg_name']['index_share_title'] = '首页分享标题';
$_LANG['cfg_desc']['index_share_title'] = '#userName分享人名称';
$_LANG['cfg_name']['index_share_content'] = '首页分享内容';
$_LANG['cfg_desc']['index_share_content'] = '#userName分享人名称';

$_LANG['cfg_name']['goods_share_title'] = '详情页分享标题';
$_LANG['cfg_desc']['goods_share_title'] = '#userName分享人名称,#goodsName商品名';
$_LANG['cfg_name']['goods_share_content'] = '详情页分享内容';
$_LANG['cfg_desc']['goods_share_content'] = '#userName分享人名称,#goodsName商品名';
?>
