...
$_LANG['app_name'] = '青山老农分销系统';
$_LANG['cp_home'] = '青山老农分销系统';
$_LANG['copyright'] = '版权所有 &copy; 2014-2015 青山老农分销系统，并保留所有权利。';
...
$_LANG['questionnaire_add'] = '添加问卷调查';
...
$_LANG['sale_product_list'] = '产品销售明细';
$_LANG['sale_statis'] = '销售订单统计';
...
$_LANG['10_user_account_setting'] = '提现设置';
$_LANG['10_user_account_manage'] = '资金管理';
$_LANG['zdy_parent'] = '查看|编辑推荐关系列表';
...
$_LANG['wx_hongbao_reply']   = '发红包提醒';
$_LANG['wx_smgz_reply']   = '扫描海报关注提醒';
$_LANG['wx_share_shouye']   = '分享首页缩略图设置';
$_LANG['wx_share_danpin']   = '分享单品缩略图设置';
$_LANG['wx_remind']   = '下单通知管理员';
$_LANG['wx_msg_setting']   = '微信提醒设置';
//手册
