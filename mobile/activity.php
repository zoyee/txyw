...
if ($_GET['act'] == 'asynclist') {
    ...
    if (is_array($list)) {
        foreach ($list as $val) {
            ...
            if ($val['act_range'] != $_LANG['far_all']) {
                ...
                foreach ($val['act_range_ext'] as $key => $value) {
                    @$extends .="<a href=\"" . $val['program'] . $value['id'] . "\" taget='_blank' class='f6'><span class='f_user_info'><u style='font-size: 0.8rem;'>" . $value['name'] . "</u></span></a>";
                }
            }
            $user_rank = "";
            ...
            $sayList[] = array(
                'pro-inner' => '<section style="padding-left: 0px; padding-right: 0px;" class="order_box padd1 radius10"><table class="ectouch_table" width="100%" border="0" cellspacing="0" cellpadding="5">
        <tr>
          <td width="20%" style="padding-left: 0px;" bgcolor="#ffffff" align="right">优惠名称：</td>
          <td width="75%" colspan="3" bgcolor="#ffffff" align="left">' . $val['act_name'] . '</td>
        </tr>
        <tr>
          <td width="20%" style="padding-left: 0px;" bgcolor="#ffffff" align="right">开始时间：</td>
          <td width="30%" bgcolor="#ffffff" align="left">' .substr( $val['start_time'],0,10) . '</td>
          <td width="20%" style="padding-left: 0px;" bgcolor="#ffffff" align="right">' . $_LANG['label_max_amount'] . '
            </td>
        ...
        <tr>
          <td bgcolor="#ffffff" style="padding-left: 0px;" align="right">结束时间：</td>
          <td bgcolor="#ffffff" align="left">' . substr( $val['end_time'],0,10) . '</td>
          <td bgcolor="#ffffff" style="padding-left: 0px;" align="right">' . $_LANG['label_min_amount'] . '</td>
          <td width="200" bgcolor="#ffffff" align="left">' . $val['min_amount'] . '</td>
        </tr>
       
        <tr>
      		<td bgcolor="#ffffff" style="padding-left: 0px;" align="right">' . $_LANG['label_act_range'] . '</td>
           	<td colspan="3" bgcolor="#ffffff" align="left"> ' .$extends.'
          </td>
        </tr>
        <tr>
      		<td bgcolor="#ffffff" style="padding-left: 0px;" align="right">优惠会员：</td>
           	<td colspan="3" bgcolor="#ffffff" align="left"> '.$user_rank.'
          	</td>
        </tr>
        <tr>
          <td bgcolor="#ffffff" style="padding-left: 0px;" align="right">' . $_LANG['label_act_type'] . '</td>
