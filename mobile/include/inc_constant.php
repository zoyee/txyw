...
define('CART_PINTUAN_GOODS',        7); // 拼团
...
define('OS_RETURNED_PEDDING',       7); // 申请退货
...
define('SEND_BY_MOBILE',            4); // 线绑定手机发放
...
/* 配送方式 */
define('SHIP_LIST', 'cac|city_express|ems|flat|fpd|post_express|post_mail|presswork|sf_express|sto_express|yto|zto|huitongkuaidi|uc56');
