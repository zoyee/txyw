 ...
 * ============================================================================
 * $Author: liubo $
 * $Id: tt_express.php 17217 2011-01-19 06:29:08Z liubo $
 */
...
$shipping_lang = ROOT_PATH.'lang/' .$GLOBALS['_CFG']['lang']. '/shipping/tt_express.php';
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 配送方式的描述 */
    $modules[$i]['desc']    = 'tt_express_desc';
    ...
    /* 打印单背景 */
    $modules[$i]['print_bg'] = '/images/receipt/dly_tt_express.jpg';
...
class tt_express
{
    ...
    function kuaidi100($invoice_sn){
    	...
    	$url = "http://api.kuaidi.com/openapi.html?id=$kuaidi_key&com=tiantian&nu=$invoice_sn&show=0&muti=0&temp=" . time();
