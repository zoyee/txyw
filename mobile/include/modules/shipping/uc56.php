 ...
 * ============================================================================
 * $Author: liubo $
 * $Id: uc56.php 17217 2011-01-19 06:29:08Z liubo $
*/

$shipping_lang = ROOT_PATH.'lang/' .$GLOBALS['_CFG']['lang']. '/shipping/uc56.php';
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 打印单背景 */
    $modules[$i]['print_bg'] = '/images/receipt/dly_uc56.jpg';
...
class uc56
{
    ...
    function query($invoice_sn)
    {
        $str = '<form style="margin:0px" methods="post" '.
            'action="http://www.uc56.cn/bill.asp" name="queryForm_' .$invoice_sn. '" target="_blank">'.
    ...
    /**
     * 返回快递100查询链接 by liuzhy
     * URL：https://code.google.com/p/kuaidi-api/wiki/Open_API_Chaxun_URL
     */
    function kuaidi100($invoice_sn){
    	include_once(ROOT_PATH. "plugins/kuaidi100_config.php");
    	$url = "http://api.kuaidi.com/openapi.html?id=$kuaidi_key&com=youshuwuliu&nu=$invoice_sn&show=0&muti=0&temp=" . time();
//     	$url = 'http://m.kuaidi100.com/query?type=youshuwuliu&id=1&postid=' .$invoice_sn. '&temp='.time();
    	return $url;
    }
