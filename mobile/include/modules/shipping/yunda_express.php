...
$shipping_lang = ROOT_PATH.'lang/' .$GLOBALS['_CFG']['lang']. '/shipping/yunda_express.php';
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 配送方式的描述 */
    $modules[$i]['desc']    = 'yunda_express_desc';
    ...
    /* 打印单背景 */
    $modules[$i]['print_bg'] = '/images/receipt/dly_yunda_express.jpg';
...
class yunda_express
{
     ...
     * @return null
     */
    function yunda_express($cfg=array())
    {
    ...
    function kuaidi100($invoice_sn){
    	...
    	$url = "http://api.kuaidi.com/openapi.html?id=$kuaidi_key&com=yunda&nu=$invoice_sn&show=0&muti=0&temp=" . time();
//         $url = 'http://m.kuaidi100.com/query?type=yunda&postid=' .$invoice_sn. '&temp='.time();
        return $url;
    }
}
