...
$shipping_lang = ROOT_PATH.'lang/' .$GLOBALS['_CFG']['lang']. '/shipping/huitongkuaidi.php';
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 配送方式插件的代码必须和文件名保持一致 */
    $modules[$i]['code']    = 'huitongkuaidi';

    $modules[$i]['version'] = '1.0.0';

    /* 配送方式的描述 */
    $modules[$i]['desc']    = 'huitongkuaidi_desc';
    ...
    /* 插件作者的官方网站 */
    $modules[$i]['website'] = 'http://www.we10.cn';
...
class huitongkuaidi
{
     ...
     * @return null
     */
    function huitongkuaidi($cfg = array())
    {
    ...
    function kuaidi100($invoice_sn){
    	...
    	$url = "http://api.kuaidi.com/openapi.html?id=$kuaidi_key&com=huitongkuaidi&nu=$invoice_sn&show=0&muti=0&temp=" . time();
//         $url = 'http://m.kuaidi100.com/query?type=huitongkuaidi&id=1&postid=' .$invoice_sn. '&temp='.time();
        return $url;
    }
