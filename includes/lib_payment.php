...
{
	$logger = LoggerManager::getLogger('include/lib_payment.php');
    /* 取得支付编号 */
        ...
        if ($pay_log && $pay_log['is_paid'] == 0)
        {
            ...
            $GLOBALS['db']->query($sql);
				...
				if($fenxiao_flage=="pay"){
					...
					log_account_change($order['user_id'], 0, 0, intval($integral['rank_points']), intval($integral['custom_points']), "下单：$order_sn,赠送积分", $order['order_sn']);
				}
