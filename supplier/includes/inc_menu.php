...
$modules['02_cat_and_goods']['01_goods_list']       = 'goods.php?act=list';         // 审核通过商品
//dqy add start 2011-7-14
$modules['02_cat_and_goods']['01_goods_list1']       = 'goods1.php?act=list';         // 未审核商品
$modules['02_cat_and_goods']['01_goods_list2']       = 'goods2.php?act=list';         // 审核未通过商品
//dqy add end 2011-7-14
...
$modules['04_order']['11_order_Import']              = 'upload.php';
